...
Wir haben die Web-Funktionalität in dem gegebenen Projekt schon erledigt. Die Interaktion mit den Requests ist also für alle Use-Cases bereits erledigt. 
Ihr müsst also nur in der Servlet-Klasse den ToDos und den Beispielen folgen und dort die geforderten Klassen und Funktionen einfügen. Die GUI (HTML/Javascript) 
für den Client-Browser) ist auch bereits erledigt. Wichtig für die Kommunikation mit dem Servlet ist allerdings das Format der Daten. Die Beispiele sollten genug 
